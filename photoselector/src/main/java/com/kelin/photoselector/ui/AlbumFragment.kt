...
internal class AlbumFragment : BasePhotoSelectorFragment() {
    ...
    private val isSelectImageOrVideo by lazy { (albumType == AlbumType.PHOTO_OR_VIDEO) }
    ...
    private val message by lazy {
        when (albumType) {
            ...
            AlbumType.PHOTO_VIDEO -> getString(R.string.kelin_photo_selector_pictures_and_videos)
            else -> getString(R.string.kelin_photo_selector_pictures_or_videos)
        }
    }
